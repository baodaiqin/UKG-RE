...
def preprocess(fixlen, sf, dir_out_train, dir_out_test):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default=None, required=True, help='path to the input dataset')
    parser.add_argument('--fixlen', type=int, default=120, help='the fixed length of a path')
    ...
    preprocess(args.fixlen, args.data, args.dir_out_train, args.dir_out_test)
