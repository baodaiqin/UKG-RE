...
class UGDSRE:
    ...
    def __preprocess_ug_paths(self, bags):
        ...
        def indexing_paths(paths, posis, total):
            ...
            return paths_head, paths_tail, paths_word, paths_posi1, paths_posi2, np.array(instance_scope), complexity_features(paths_word)
        ...
        paths_head, paths_tail, paths_word, paths_posi1, paths_posi2, instance_scope, paths_comp_fea = indexing_paths(paths, posis, total)
        scope = [0]
        for num in instance_scope:
            scope.append(scope[len(scope)-1] + num[1] - num[0] + 1)

        return paths_head, paths_tail, paths_word, paths_posi1, paths_posi2, np.array(scope), paths_comp_fea
